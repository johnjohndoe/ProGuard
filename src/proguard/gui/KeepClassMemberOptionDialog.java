/* $Id: KeepClassMemberOptionDialog.java,v 1.7 2003/12/06 22:12:42 eric Exp $
 *
 ...
 */
class KeepClassMemberOptionDialog extends JDialog
{
    /**
    ...
    public KeepClassMemberOptionDialog(JDialog owner,
                                       boolean isField)
    {
        super(owner, true);
        setResizable(true);
    ...
    /**
     * Sets the KeepClassMemberOption to be represented in this dialog.
     */
    public void setKeepClassMemberOption(KeepClassMemberOption keepClassMemberOption)
    {
        String name       = keepClassMemberOption.name;
        String descriptor = keepClassMemberOption.descriptor;

        // Set the access radio buttons.
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_PUBLIC,       publicRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_PRIVATE,      privateRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_PROTECTED,    protectedRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_STATIC,       staticRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_FINAL,        finalRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_VOLATILE,     volatileRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_TRANSIENT,    transientRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_SYNCHRONIZED, synchronizedRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_NATIVE,       nativeRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_ABSTRACT,     abstractRadioButtons);
        setKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_STRICT,       strictRadioButtons);
    ...
    /**
     * Returns the KeepClassMemberOption currently represented in this dialog.
     */
    public KeepClassMemberOption getKeepClassMemberOption()
    {
        ...
        KeepClassMemberOption keepClassMemberOption = fullWildcard ?
            new KeepClassMemberOption(0,
                                      0,
                                      null,
                                      null,
                                      null) :
        ...
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_PUBLIC,       publicRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_PRIVATE,      privateRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_PROTECTED,    protectedRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_STATIC,       staticRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_FINAL,        finalRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_VOLATILE,     volatileRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_TRANSIENT,    transientRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_SYNCHRONIZED, synchronizedRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_NATIVE,       nativeRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_ABSTRACT,     abstractRadioButtons);
        getKeepClassMemberOptionRadioButtons(keepClassMemberOption, ClassConstants.INTERNAL_ACC_STRICT,       strictRadioButtons);

        return keepClassMemberOption;
    }
     ...
     */
    private void setKeepClassMemberOptionRadioButtons(KeepClassMemberOption keepClassMemberOption,
                                                      int                   flag,
                                                      JRadioButton[]        radioButtons)
    {
        if (radioButtons != null)
        {
            int index = (keepClassMemberOption.requiredSetAccessFlags   & flag) != 0 ? 0 :
                        (keepClassMemberOption.requiredUnsetAccessFlags & flag) != 0 ? 1 :
                                                                                       2;
     ...
     * button triplet.
     */
    private void getKeepClassMemberOptionRadioButtons(KeepClassMemberOption keepClassMemberOption,
                                                      int                   flag,
                                                      JRadioButton[]        radioButtons)
    {
        if (radioButtons != null)
        {
            ...
            {
                keepClassMemberOption.requiredSetAccessFlags   |= flag;
            }
            else if (radioButtons[1].isSelected())
            {
                keepClassMemberOption.requiredUnsetAccessFlags |= flag;
            }
        }
    }
}
