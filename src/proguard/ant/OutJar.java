/* $Id: OutJar.java,v 1.2 2003/12/19 04:17:03 eric Exp $
 *
...
/**
 * Handles the outjar nested task for the ProGuard task.
 *
...
{
    /**
     * Creates a new OutJar nested task.
     */
    public OutJar()
    {
        super();
    ...
    {
        proGuardConfiguration.addOutjar(jar);
    }
}
